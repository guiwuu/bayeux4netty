...
/**
 * A Bayeux <a href="http://svn.cometd.org/trunk/bayeux/bayeux.html#toc_53">Connect Response</a>
 *
 ...
 * @author daijun
 */
public class ConnectResponse extends BayeuxMessage {

    public ConnectResponse(ConnectRequest request) {
        super(request);
        this.timestamp = BayeuxUtil.getCurrentTime();
    }

    public ConnectResponse(String clientId, boolean successful){
    ...
    public static boolean isValid(BayeuxMessage bayeux) {
        if (!bayeux.channel.equals("/meta/connect")) {
            return false;
        }
